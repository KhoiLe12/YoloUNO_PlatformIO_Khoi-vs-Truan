...
static volatile float g_latest_ml_score = NAN;

float get_latest_ml_score(){
    // simple non-atomic read is fine for a float on this platform; if needed, add a mutex
    return g_latest_ml_score;
}
